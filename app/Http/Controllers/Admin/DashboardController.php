...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard', compact('totalShop', 'totalOrder', 'totalCustomer', 'totalProduct', 'orderStatuses', 'topCustomers', 'topSellingProducts', 'topReviewProducts', 'topShops', 'latestOrders', 'topFavorites', 'pendingWithdraw', 'alreadyWithdraw', 'deniedWithddraw', 'totalCommission', 'totalCategories', 'flashSale', 'totalRider'));
    }
    ...
    public function orderStatistics()
    {
        ...
        $shop = $generleSetting?->shop_type == 'single' ? generaleSetting('shop') : null;
